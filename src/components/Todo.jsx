...
const Todo = (props) => {
  ...
  return (
    <div className="duration-200 ease-linear flex hover:bg-gray-100 transition-all justify-between pl-5 text-gray-900 bg-white border-b h-14 dark:text-white dark:bg-[#610094]">
      <div
